  ...
  return (
    <footer className="bg-slate-950 text-slate-300 pt-16 pb-8 border-t border-slate-800">
      <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-12 lg:gap-8 mb-12">
          ...
          <div className="space-y-6 mb-8 md:mb-0">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">Kabupaten Deli Serdang</p>
              </div>
            </div>
            <div className="text-sm space-y-2 leading-relaxed">
              <p className="flex items-start gap-2">
                <MapPin size={16} className="text-primary shrink-0 mt-1" />
                <span>Jl. Lintas Utama No.01 Dusun Walaho<br />Desa Walaho, Kecamatan Beringin<br />Kabupaten Deli Serdang<br />Provinsi Sumatera Utara, 20552</span>
              </p>
